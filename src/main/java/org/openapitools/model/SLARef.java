...
public class SLARef   {
  ...
  */
  @NotNull 
  @Schema(name = "id", description = "Unique identifier of service level agreement", required = true)
  public String getId() {
    return id;
  }
  ...
  */
  ...
  @Schema(name = "href", description = "Reference of the service level agreement", required = false)
  ...
  */
  ...
  @Schema(name = "name", description = "Name of the service level agreement", required = false)
